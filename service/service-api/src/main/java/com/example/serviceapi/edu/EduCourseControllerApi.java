 ...
 */
public interface EduCourseControllerApi {
     ...
     */
    @GetMapping
    R selectAll(Page<EduCourse> page, EduCourse entity);
     ...
     */
    @PostMapping
    R insert(@RequestBody EduCourse entity);
     ...
     */
    @PutMapping
    R update(@RequestBody EduCourse entity);
